...
/**
 * help_alias - renders help for alais
 */
void help_alias(void)
{
...
/**
 * help_cd - it changes help for the
 */
void help_cd(void)
{
...
/**
 * help_exit - print msg to help exit the pr
 */
void help_exit(void)
{
